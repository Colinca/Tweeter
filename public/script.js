  ...
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <div id="buttons-${key}">
          <button style="background-color:#e6674c" id="likebutton" href="#" class="btn btn-primary like button" data-uuid="${key}">Like</button>
          <button style="background-color:#31e1df" id="retweetbutton" href="#" class="btn btn-primary retweet button" data-uuid="${key}">Retweet</button>
        </div>
      </div>
    </div>
  </div>
